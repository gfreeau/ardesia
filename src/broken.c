...
static gfloat
calculate_edge_degree (AnnotateStrokeCoordinate *point_a,
 ...
 */
GSList *
extract_relevant_points (GSList *list_inp, gboolean close_path, gdouble pixel_tollerance)
{
	  ...
	  if (close_path)
	    {
	      ...
	      if (is_similar_to_a_regular_polygon (relevant_list, pixel_tollerance))
		{
		  relevant_list = extract_polygon (relevant_list);
		} 
	      else
		{
